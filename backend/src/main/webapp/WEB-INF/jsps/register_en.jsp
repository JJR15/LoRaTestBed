            ...
            <div class="row-fluid">
                <div class="box span6" style="margin-left: 25%;">
                    <div class="box-header" data-original-title="">
                        <h2><i class="icon-edit"></i><span class="break"></span>User Register</h2>
                    </div>
                        ...
                        <form class="form-horizontal" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <span class="help-inline hidden">The two passwords differ</span>
                                </div>
                            </div>
                            <div class="m-form-actions">
                                <button type="button" onclick="register()"  class="btn btn-primary">Register</button>
                                <button type="reset" class="btn" style="margin-left: 40px">Reset</button>
                            </div>
                        </form>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data === "true") {
                    ...
                    alert("New account registration failed: user name already exists.");
                }
            },
            error: function () {
                alert("系统繁忙，稍后再试！");
