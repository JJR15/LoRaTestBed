...
<div class="container-fluid-full">
            ...
            <div class="row-fluid">
                <div class="box span12">
                    <div class="box-header" data-original-title="">
                        <h2><i class="icon-map-marker"></i><span class="break"></span>My Orders</h2>
                    </div>
    ...
    <div class="modal hide fade" id="nodeOrderCancelDialog">
        ...
        <div class="modal-body">
            Are you sure to cancel orders of node <span class="node-id node-ids"></span>?
        </div>
        <div class="modal-footer">
            <a href="#" class="btn btn-primary" onclick="submitCancel()">OK</a>
