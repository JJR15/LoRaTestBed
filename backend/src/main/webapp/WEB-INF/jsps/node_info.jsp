...
<div class="container-fluid-full">
            ...
            <div class="row-fluid">
                <div class="box span12">
                    <div class="box-header" data-original-title="">
                        <h2><i class="icon-map-marker"></i><span class="break"></span>节点信息</h2>
                    </div>
                        ...
                        <table id="node-info-datatable" class="table table-striped table-bordered bootstrap-datatable">
                            ...
                            <c:forEach items="${node_infos}" var= "node_info" varStatus="node_status">
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info" onclick="orderBtn(${node_info.id})">
                                            预定
                                        </button>
                                    </td>
                                </tr>
    ...
    <div class="modal hide fade" id="nodeOrderDialog">
        ...
        <div class="modal-body">
            <p>节点ID：<span class="node-id node-ids">1</span></p>
            <div class="center">
                开始时间：
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-primary" onclick="submitOrder()">确认</a>
    ...
    <div class="modal hide fade" id="nodeOrderInfoDialog">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">×</button>
            <h3>节点<span class="node-id"></span>预定情况</h3>
        </div>
    ...
    <div class="modal hide fade" id="nodePositionDialog">
        ...
        <div class="modal-body">
            ...
            <p style="line-height: 25px">
                节点ID:<span class="node-id">01</span> <br/>
                经度:<span id="longitude">116.339041</span>,  &nbsp; 纬度:<span id="latitude">40.007689</span>
            </p>
