            ...
            <div class="row-fluid">
                <div class="box span12">
                    <div class="box-header" data-original-title="">
                        <h2><i class="icon-map-marker"></i><span class="break"></span>Outputs of Node ${id}</h2>
                    </div>
                    <div class="box-content">
                        <div id="data" class="cmd-area"></div>
                    </div>
                </div>
            </div>
        </div>
