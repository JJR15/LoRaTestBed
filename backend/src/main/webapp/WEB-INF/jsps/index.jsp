        ...
        <div id="content" class="span10" style="min-height: 678px;">
            <div class="row-fluid" style="line-height: 40px">
                <div class="span3 smallstat box mobileHalf" ontablet="span6" ondesktop="span3">
                    <span class="title m-title"> 用户总数</span>
                    <span class="m-value">${total_user}</span>
                </div>
                <div class="span3 smallstat box mobileHalf" ontablet="span6" ondesktop="span3">
                    <span class=" m-title"> 节点数</span>
                    <span class="m-value"> ${total_node}</span>
                </div>
                <div class="span3 smallstat box mobileHalf" ontablet="span6" ondesktop="span3">
                    <span class="title m-title">正在运行</span>
                    <span class="m-value">${running_node}</span>
                </div>
            </div>
            <div class="row-fluid">
