        ...
        <div class="container-fluid">
            ...
            <div class="nav-no-collapse header-nav">
                <ul class="nav pull-right">
                    <li class="dropdown">
                        <a href="?language=zh" style="padding: 0; color: white;text-shadow: none"><span> [中文版]</span></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row-fluid">
            <div class="login-box">
                <h2>Login to LoRa TestBed</h2>
                    ...
                    <button onclick="login()" class="btn btn-primary span12">Login</button>
                    <p>Don't have a account? <a href="<%=basePath%>user/register" style="color:#CC9933">sign up here</a></p>
                <hr />
...
<script>
    ...
    function login() {
        $.post("<%=basePath%>login?language=en",{"username":$("#username").val(),"password":$("#password").val()},function (response) {
            $("#nodeBurnDialog").modal("hide");
            if(response==="success"){
                window.location.href="<%=basePath%>index?language=en";
            }
