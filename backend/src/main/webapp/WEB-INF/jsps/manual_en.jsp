            ...
            <div class="row-fluid">
                <div class="box span12">
                    <div class="box-content">
                        <h3>Quick Start</h3>
                            <img src="<%=basePath%>img/guide1.png"style="height:300px;width:600px">
                            <p>1. Click Node Ordering to order node</p>
                            <img src="<%=basePath%>img/guide2.png"style="height:300px;width:600px">
                            <p>2. Click Node manage to see your order</p>
                            <img src="<%=basePath%>img/guide3.png"style="height:300px;width:600px">
                            <p>3. You can burn ,start or stop the node with your bin file</p>
                    </div>
                </div>
            </div>
        </div>
