...
<div class="navbar">
    <div class="navbar-inner" style="min-height: 60px">
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <a class="brand span2 my-navbar" href="index?language=en"><span>LORA TESTBED</span></a>
            </div>
            <!-- start: Header Menu -->
            <div class="nav-no-collapse header-nav">
                <ul class="nav pull-right">
                    <li class="dropdown">
                        <a href="?language=zh" style="padding: 0 40px 0 0; color: white;text-shadow: none"><span> [中文版]</span></a>
                    </li>
