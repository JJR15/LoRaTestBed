export default {
  ...
  //以上为模板自带，以下为自定义之语言
  'menu.homepage': '系统概况',
  'app.analysis.totaluser': '用户数',
  'app.analysis.intro.totaluser': '在本系统注册的用户总数',
  'app.analysis.nodenum': '节点数',
  'app.analysis.intro.nodenum': '当前系统拥有的LoRa节点总数',
  'app.analysis.runnum': '运行的节点数',
  'app.analysis.intro.runnum': '当前运行中的节点总数',
  'menu.node': '节点预定',
  'menu.node.node_order': '预定节点',
  'menu.node.my_order': '我的预定',
  'menu.node_manage': '节点管理',
  'menu.node_manage.list_view': '室内节点列表',
  'menu.node_manage.list_view_out': '室外节点列表',
  'menu.node_manage.gateway': '网关列表',
  'menu.node_manage.show_data': '数据展示',
  'menu.node_manage.map_view': '地图视图',
  'menu.userguide': '使用说明',
