export default {
  ...
  //以上为模板自带，以下为自定义之语言
  'menu.homepage': 'About System',
  "app.analysis.totaluser" : 'number of Users',
  "app.analysis.intro.totaluser" : 'Total number of users registered in this system',
  "app.analysis.nodenum": 'number of Nodes',
  "app.analysis.intro.nodenum": 'The total number of LoRa nodes owned by the system',
  "app.analysis.runnum": "number of Running Nodes",
  "app.analysis.intro.runnum": "The total number of nodes currently running",
  "menu.node": "Node Ordering",
  "menu.node.node_order": "Node Ordering",
  "menu.node.my_order": "My Ordering",
  "menu.node_manage": "Node Manage",
  "menu.node_manage.list_view": "Node List",
  "menu.node_manage.list_view_out": "Outside Node List",
  "menu.node_manage.gateway": "GateWay List",
  "menu.node_manage.map_view": "Map View",
  "menu.userguide": "User Guide",
  "menu.loraserver": "LoRaServer",
  "menu.about": "About Us",
  "menu.map_view": "Map View",
  "menu.user_manage": "User Manage",
};
