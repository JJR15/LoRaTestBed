...
const status = [ 'unusable', 'can be burned', 'running', 'closed', 'burning' ];
...
class NodeManage extends PureComponent {
  ...
  columns = [
    ...
    },
    {
      ...
      align:'center',
      render: val => {
        return <Button icon="info-circle" type="primary" onClick={ () => this.showMap(val) }>view location</Button>;
      },
    },
    {
      title: 'Node Burning',
      ...
      render: val => {
        return <>
            ...
            <Button icon="upload" type="primary" disabled={ val.status != 1 && val.status != 2 }>upload flies</Button>
    ...
    },
    {
      ...
      align:'center',
      render: val => {
        return <Button icon="info-circle" type="primary" disabled={ val.status == 0 || val.status == 3 } onClick={ () => this.viewLog(val) }>view log</Button>;
      },
    },
    {
      title: 'Other Opreating',
      align:'center',
      render: (val) => {
        return  (
        <Dropdown overlay=
